      ...
      <div className="col-span-5 pl-16">
        <div className="grid grid-cols-2 items-center place-content-center">
          <div className="col-span-1">
            <div className="textorange font-black text-6xl">Free</div>
            <div className="textblue font-semibold">No Credit Card Needed!</div>
          </div>
          <div className="col-span-1 text-right">
            <div className="textorange font-black text-6xl">$0</div>
            <div className="textblue font-semibold">Forever</div>
          </div>
        </div>
